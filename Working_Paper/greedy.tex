...
We can stop here since all of the degrees of the vertices in the graph are 0. We get $S=\{v_{1},v_{5},v_{6},v_{7}\}$. But in the implementation of the algorithm, the process continues.