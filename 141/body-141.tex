...
pick any node in the graph and set that as the start node and add that to our H.
...
for 1 to |vertices|
	...
	set the adjacent vertex of current vertex that hasn't been visited yet as the current vertex.
	H=H $\cup$ {current vertex}
