...
\end{tikzpicture}
\end{figure}
The value of the parameters of the algorithm are $\rho=0.60284$ and $d=3$, making the output a small 3-seeding target set. The table \ref{viradstable} contains the initial values needed in the algorithm.
\begin{table}[ht]
\centering
    \begin{tabular}{c c c c c}
...
\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=2cm,
  ...
  \node[main node,label={right:$v_5$}, below right of=2] (5) {$2$};
  \node[main node,label={right:$v_6$},right of=2] (6) {$2$};
  \node[main node,label={right:$v_7$},above right of=6,fill=blue] (7) {$2$};
  \node[main node,label={right:$v_8$},above left of=7] (8) {$2$};
  \node[main node,label={right:$v_9$},below of=7] (9) {$2$};
  \node[main node,label={right:$v_{10}$},below of=9] (10) {$2$};
...
\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=2cm,
  ...
  \node[main node,label={above right:$v_2$}, below of=1,fill=blue] (2) {$4$};
  \node[main node,label={right:$v_3$}, below left of=2] (3) {$1$};
  \node[main node,label={below:$v_4$}, below of=2,fill=blue] (4) {$2$};
  \node[main node,label={right:$v_5$}, below right of=2] (5) {$2$};
  \node[main node,label={right:$v_6$},right of=2] (6) {$2$};
  \node[main node,label={right:$v_7$},above right of=6,fill=blue] (7) {$2$};
  \node[main node,label={right:$v_8$},above left of=7] (8) {$2$};
...
\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=2cm,
                    thick,main node/.style={circle,draw,font=\sffamily\small\bfseries}]
  \node[main node,label={right:$v_1$},fill=blue] (1) {$2$};
  \node[main node,label={above right:$v_2$}, below of=1,fill=blue] (2) {$4$};
  \node[main node,label={right:$v_3$}, below left of=2] (3) {$1$};
  \node[main node,label={below:$v_4$}, below of=2,fill=blue] (4) {$2$};
...
\\
    \begin{tabular}{c c c c c}
		...
		$v_{5}$ & 0 & 0 & 1 & $\{\}$\\
	\end{tabular}
	\caption{4th and 5th Iteration of Virads Example, vertex $v_1$ and $v_5$ are chosen  and $P=\{v_2,v_7,v_4,v_1,v_5\}$}
\end{figure}
\newpage
