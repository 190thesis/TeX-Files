...
\begin{itemize}
	...
	\item Let $G=(V,E,\phi)$ and $G'=(V',E',\phi')$ be graphs. A \textit{homomorphism} $f:G \rightarrow G'$ from $G$ to $G'$ is an ordered pair $f=(f_1,f_2)$ of maps, $f_1:V \rightarrow V'$ and $f_2=E \rightarrow E'$, also satisfying the compatibility condition, $$\phi(e)=\{u,v\} \$$
\end{itemize}
