...
\end{tikzpicture}
  ...
  \node[main node,label={0.4}, color={red}] (A) {$A$};
  \node[main node,label={0.8},color={red}] (C) [below of=A] {$C$};
  \node[main node,label={0.2}, color={red}] (B) [right of=A] {$B$};
  \node[main node,label={0.3}, color={gray}] (D) [right of=C] {$D$};
